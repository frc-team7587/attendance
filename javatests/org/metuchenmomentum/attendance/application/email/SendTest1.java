...
//	    private final String body;
    ...
    SendTest1 (Session session, String fromEmail) { 
...
//		} catch (Exception ex) {
//	        Logger.getLogger (SendTest1.class.getName()).log(Level.SEVERE, null, ex);
///    }  
...
public static class Builder {
    ...
    public SendTest1 build() {
        Properties properties = new Properties();
            ...
            return new SendTest1(session, email);
        }
    }

	public static void main(String[] args) throws AddressException, MessagingException {
		SendTest1 sender = SendTest1.builder()
							.setEmail("fillInSendersEmail@fillInEmailprovider.com")
							.setHost("setHostLocationHere")
							.setPassword("needThePasswordHere")
							.build();
		sender.send("jun.gesteland@gmail.com", "Hi", "Sending with Java");
